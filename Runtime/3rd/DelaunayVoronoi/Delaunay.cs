...
namespace DelaunayVoronoi
{
    public class DelaunayTriangulator
    {
        ...
        public List<Point> GeneratePoints(int amount, float minX, float maxX, float minY, float maxY)
        {
            MaxX = maxX;
            MaxY = maxY;
            ...
            {
                var pointX = Random.Range(minX, maxX);
                var pointY = Random.Range(minY, maxY);
